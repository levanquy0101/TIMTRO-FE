...
function CleaningServicePage(props) {
    ...
    const cleanServices = services?.filter(service => service.service_type === "clean");
        ...
        <>
            ...
            <div className=''>
                ...
                <div className='bg-zinc-200 p-2'>
                    <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-4 my-4 max-w-md mx-auto'>
                        <input
                            type="hidden"
                        ...
                        <button type="submit" className='py-2 px-10 mx-auto bg-primary text-white cursor-pointer border-none rounded text-lg w-max'>Đặt lịch</button>
                    </form>
                </div>
            </div>
