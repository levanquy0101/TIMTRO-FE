...
export default function PostPage2() {
    return (
        <>
            <div className="bg-cover bg-center aspect-[9/2] relative"
                style={{ backgroundImage: "url('https://hoanghamobile.com/tin-tuc/wp-content/uploads/2023/07/hinh-dep-19.jpg')" }} >
                <h2 className='text-5xl p-16 absolute bottom-0 text-white text-shadow'>Máy tính tiền thuê nhà.</h2>
            </div>
            <section className='p-16'>
                <h2 className='text-[#2348ff] text-3xl'>Tôi có thể mua được bao nhiêu?</h2>
                <form className='w-3/4'>
                    ...
                    <button type="submit" className='mt-8 py-3 px-4 text-base rounded-lg bg-[#2348ff] border-none text-white'>Tra cứu</button>
                </form>
            </section>
        </>
    )
