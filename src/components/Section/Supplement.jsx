...
const Supplement = () => {
    return (
        <section>
            ...
            <p className='text-center my-6'>Chúng tôi cung cấp nhiều tiện ích khác nhau bạn có thể sử dụng một cách nhanh chóng và thuận lợi nhất.</p>
            <div className='my-4 grid grid-cols-3 gap-12'>
                <div>
                    ...
                    <p>Chúng tôi cung cấp dịch vụ dọn dẹp để có thể dọn dẹp và sắp xếp không gian sống của bạn 1 cách sạch sẽ tối ưu về thời gian và kinh phí.</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p>Chúng tôi cung cấp xe những người thợ sữa chữa nơi ở của bạn mỗi khi bạn gặp sự cố.</p>
                </div>
            </div>
        </section>
    );
