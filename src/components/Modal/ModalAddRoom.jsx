            ...
            <div className="bg-white p-6 rounded-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className=" grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        />
                        {errors.price && (
                            <small className="text-red-500 text-xs">{errors.price.message}</small>
                        )}
                    </div>
                    ...
                    <div>
                        ...
                        />
                        {errors.area && (
                            <small className="text-red-500 text-xs">{errors.area.message}</small>
                        )}
                    </div>
                    ...
                    {[
                        ...
                        <div key={item.key}>
                            ...
                            <input
                                type="number"
                                {...register(item.key, { required: `${item.label} là bắt buộc` })}
                                className="w-full border outline-none border-gray-300 rounded-md p-2"
                            />
                            {errors[item.key] && (
                    ...
                    <div>
                        ...
                        />
                        {errors.province_id && (
                            <small className="text-red-500 text-xs">{errors.province_id.message}</small>
                        )}
                    </div>
                    ...
                    <div>
                        ...
                        />
                        {errors.district_id && (
                            <small className="text-red-500 text-xs">{errors.district_id.message}</small>
                        )}
                    </div>
                    ...
                    <div>
                        ...
                        />
                        {errors.address && (
                            <small className="text-red-500 text-xs">{errors.address.message}</small>
                        )}
                    </div>
