                        ...
                        <form onSubmit={handleSubmitForm1(onSubmitForm1)} className='flex flex-col gap-4'>
                            ...
                            <div className='flex gap-4 text-zinc-600'>
                                ...
                                <label className='flex gap-2'>
                                    <input value="user" type="radio" {...registerForm1("role", { required: "Trường là bắt buộc!" })} />
                                    Khách thuê
                                </label>
                                <label className='flex gap-2'>
                                    <input value="landlord" type="radio" {...registerForm1("role", { required: "Trường là bắt buộc!" })} />
                                    Chủ trọ
                                </label>
                            </div>
