                ...
                <nav className='flex w-full justify-between py-6 px-20'>
                    ...
                    <ul className='flex gap-8 items-center'>
                        ...
                        <li className='rounded-md border border-primary border-solid px-2 py-1.5 text-primary'>
                            <button onClick={handleRegister} className='text-primary text-base bg-transparent border-none cursor-pointer'>Đăng ký</button>
                            <span className='text-primary mx-1'>|</span>
                            <button onClick={handleLogin} className='text-primary text-base bg-transparent border-none cursor-pointer'>Đăng nhập</button>
                        </li>
                    </ul>
                </nav>
            </header>
            <ModalMenuSign isOpen={isModalSign} typeModal={typeModalSign} onClose={handleReset}/>
        </>
    );
};
